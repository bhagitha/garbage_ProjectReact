...
import Recycler_nav from './recycler_nav';
...
class recycler_dashboard extends Component {
  constructor (props) {
    super(props);
    this.state = {
  ...
  AcceptRequest=(id,status)=>{
    ...
    const url="http://localhost:3000/recycle/accept-recycle/"+id
...
export default recycler_dashboard;